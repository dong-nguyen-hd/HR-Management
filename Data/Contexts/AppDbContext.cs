...
namespace HR_Management.Data.Contexts
{
    public class AppDbContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder builder)
        {
            ...
            builder.Entity<Location>().Property(x => x.City).IsRequired().HasColumnType("nvarchar(500)");
            builder.Entity<Location>().Property(x => x.Country).IsRequired().HasColumnType("nvarchar(500)");
            ...
            builder.Entity<Person>().Property(x => x.Email).IsRequired().HasColumnType("nvarchar(500)");
            builder.Entity<Person>().Property(x => x.Avatar).IsRequired().HasColumnType("varchar(250)");
            builder.Entity<Person>().Property(x => x.Description).IsRequired().HasColumnType("nvarchar(500)");
            builder.Entity<Person>().Property(x => x.Phone).IsRequired().HasColumnType("varchar(25)");
            builder.Entity<Person>().Property(x => x.CreatedBy).IsRequired().HasColumnType("nvarchar(500)");
            builder.Entity<Person>().Property(x => x.UpdatedBy).IsRequired(false).HasColumnType("nvarchar(500)");
