...
namespace HR_Management.Data.Repositories
{
    public class ProjectRepository : BaseRepository, IProjectRepository
    {
        ...
        {
            var temp = await _context.Projects.Where(x => x.Id == id && x.Status).FirstOrDefaultAsync();
        ...
        {
            var tempList = await _context.Projects.Where(x => x.PersonId == personId && x.Status).ToListAsync();
